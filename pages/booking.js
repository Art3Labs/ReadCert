...
import VideoBackground from '../components/Funcionalidad/VideoBackground2';
    ...
    <>
      ...
      <section className='bg-gradient-to-b from-indigo-900 to-gray-400 '>
        ...
        <div className='p-4 mx-auto max-w-screen-xl lg:pt-10 pb-10'>
          ...
          <div>
            <div className='mt-10 mb-2- mx-auto' style={{ maxWidth: "900px" }} >
              <div className='p-4 bg-gray-100 rounded-lg border border-gray-200 shadow-md' style={{ maxWidth: "900px" }}>
                <VideoBackground />              </div>
